  ...
  template: `
    <div class="help-guide">
      ...
      <div id="help-gacha" class="os-panel help-section">
        ...
        <ul class="help-list">
          ...
          <li><strong>募集モード</strong> ─ サイドパネルから切替。
            <ul>
              <li><strong>通常募集</strong> ─ 恒常排出(★3=3%)</li>
              <li><strong>ピックアップ募集</strong> ─ PU生徒の確率がアップ(PU★3=0.7%)</li>
              <li><strong>期間限定募集</strong> ─ アニバ仕様(★3合計=6%)</li>
            </ul>
          </li>
      ...
      <div id="help-materials" class="os-panel help-section">
        ...
        <p>装備素材・スキル素材・クレジット・ピロキセンなどの<strong>在庫管理</strong>と、生徒ごとの<strong>必要素材</strong>を一覧できます。</p>
        <ul class="help-list">
          <li><strong>在庫の編集</strong> ─ 数値を直接書き換えると自動で保存されます。</li>
          <li><strong>カテゴリ別の絞り込み</strong> ─ サイドパネルから装備T1〜T4 / スキル / クレジット / ピロキセンなどで絞り込めます。</li>
          <li><strong>必要素材の集計</strong> ─ 各生徒の詳細画面で「必要素材」を登録すると、このタブで合計が確認できます。</li>
        </ul>
      </div>
